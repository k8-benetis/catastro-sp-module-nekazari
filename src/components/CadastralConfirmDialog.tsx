      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-white">Parcela Catastral Encontrada</h3>
          </div>
          {!isProcessing && (
            <button
              onClick={onCancel}
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="flex-1">
                <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Referencia Catastral</p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-200">
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Municipio</p>
